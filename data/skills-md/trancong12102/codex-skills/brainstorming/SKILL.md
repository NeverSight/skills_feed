...
name: brainstorming
description: >
  Guide collaborative brainstorming to turn ideas into clear designs and specs.
  Use before creative work (new features, components, functionality, or behavior
  changes) to clarify intent, constraints, and success criteria.
---
