...
If a story is too big, the implementation often fails or produces broken code.
...
- **Always include "Typecheck/lint passes"** as the final criterion for every story.
...
- [ ] **Dependency Order followed** (Schema → Backend → UI)
- [ ] **Sequential IDs used** (US-001, US-002, etc.)
- [ ] **Mandatory Criteria included:** "Typecheck/lint passes" on every story
- [ ] **UI stories include:** "Verify in browser using agent-browser skill"
