---
name: obsidian-bases
description: Use when creating or editing Obsidian Bases (.base files) that define views, filters, formulas, or summaries for note collections.
---
...
## When to Use
- Designing or updating `.base` files to surface filtered views, tables, cards, or summaries inside Obsidian.
...
- The task is outside Obsidian (other editors or platforms) with no `.base` files involved.
