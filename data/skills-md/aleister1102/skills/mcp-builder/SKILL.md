---
name: mcp-builder
description: Use when building MCP (Model Context Protocol) servers that expose external APIs or services via well-designed tools, whether in Python (FastMCP) or Node/TypeScript (MCP SDK).
---
