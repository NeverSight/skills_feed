...
description: Use when the user provides vague requirements or needs prompt refinement, and you must convert them into precise EARS-based specifications.
---
...
- The requirement is already precise, measurable, and ready for execution.
- The request focuses on debugging or running code rather than improving prompts.
- You are executing plan steps or programming tasks, not crafting prompt specifications.
