...
description: Use when executing Windows domain penetration techniques such as Kerberoasting, DCSync, Golden/Silver Ticket, or NTLM relay during red-team or bug-bounty engagements.
---
...
## Overview
Red-team operators leverage credential harvesting, Kerberos abuses, and lateral-movement tooling to dominate Windows domains after gaining initial access.

## When to Use
- During authorized red-team or bug-bounty engagements targeting Active Directory infrastructure.
- When you need to escalate privileges or persist by abusing Kerberos tickets (Kerberoasting, DCSync, Golden/Silver Ticket, NTLM relay).
- When enumerating AD attack paths with BloodHound, PowerView, or similar tooling before exploiting high-value accounts.

## When NOT to Use
- Attempts without explicit authorization or outside of scoped engagement rules.
- General Windows troubleshooting, defensive analysis, or benign audit work.
- Non-AD systems where the focus is pure Linux or cloud-native infrastructure.
